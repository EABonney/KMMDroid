...
public class KMMDCustomFastScrollView extends FrameLayout 
    ...
    public KMMDCustomFastScrollView(Context context) {
        super(context);
    ...
    public KMMDCustomFastScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);

        init(context, attrs);
    }

    public KMMDCustomFastScrollView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void draw(Canvas canvas) {
        ...
        final KMMDCustomFastScrollView.ScrollFade scrollFade = mScrollFade;
